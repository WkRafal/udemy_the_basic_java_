...
public class MaxMinMethods {
    public static void main(String[] args) {
        ...
        Car carHighersPrice = cars.stream()
                .max((car1, car2) -> car1.price > car2.price ? 1 : -1)
                .get();

        System.out.println(carHighersPrice);
        ...
        Car carMaxSpeed = cars.stream()
                .max((car1, car2) -> car1.topSpeed > car2.topSpeed ? 1 : -1)
                .get();

        System.out.println(carMaxSpeed);
